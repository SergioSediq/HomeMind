...
**Search Options:**
â€¢ **Text Search**: Enter keywords like "3 bed homes" or "condos under 500k"
â€¢ **ZPID Search**: Use URL parameter ?zpids=123,456 for specific properties
â€¢ **Default View**: Shows 50 sample properties when no search is active

**Map Features:**
â€¢ Click on any marker to see property details
â€¢ Popup shows ZPID, price, location, and Zillow link
â€¢ Map automatically zooms to show all results
â€¢ Drag to pan, scroll to zoom

**Search Tips:**
â€¢ Be specific: "3 bedroom houses in Chapel Hill"
â€¢ Use price ranges: "homes under 600000"
â€¢ Filter by features: "houses with pool"
â€¢ Maximum 200 properties shown for performance

**URL Parameters:**
â€¢ **?q=**: Search query (e.g., ?q=3+bed+homes)
â€¢ **?zpids=**: Comma-separated ZPIDs (e.g., ?zpids=123,456,789)`}
                      />
                    </CardTitle>
                  </CardHeader>
