...
const termsContent = `
# Terms of Service - homemind App

_Last Updated: April 18th, 2025_

Welcome to homemind Chat! These Terms of Service ("Terms") govern your use of our application ("App"). By accessing or using our App, you agree to be bound by these Terms. Please read them carefully.
...
homemind reserves the right to modify these Terms at any time. Changes will be posted on this page with an updated "Last Updated" date. Your continued use of the App after any modifications constitutes your acceptance of the new Terms.
...
## 5. User Content
You may submit content, including messages and other data, to the App. While you retain ownership of your content, you grant homemind a non-exclusive, irrevocable, royalty-free, worldwide license to use, reproduce, and display your content for purposes of operating and improving the App.
...
All content, trademarks, logos, and materials on the App are the property of homemind or its licensors and are protected by applicable laws.

## 8. Disclaimer of Warranties
The App is provided "as is" and "as available" without any warranties, whether express or implied. homemind disclaims all warranties, including the implied warranties of merchantability, fitness for a particular purpose, and non-infringement.

## 9. Limitation of Liability
In no event shall homemind be liable for any indirect, incidental, or consequential damages arising from your use of the App.

## 10. Indemnification
You agree to indemnify and hold harmless homemind, its officers, employees, and agents from any claims, losses, or damages arising out of your use of the App or violation of these Terms.

## 11. Governing Law
These Terms are governed by and construed in accordance with the laws of the jurisdiction in which homemind operates.

## 12. Termination
homemind reserves the right to suspend or terminate your access to the App at any time without notice for conduct that violates these Terms or is deemed harmful.
...
const TermsPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Terms of Service | homemind Chat</title>
        <meta
          name="description"
          content="Read the detailed Terms of Service for homemind Chat."
        />
      </Head>
              ...
              <div className="space-y-5">
                ...
                <div>
                  <h1 className="text-3xl font-bold mb-2">
                    Clear terms for using homemind.
                  </h1>
