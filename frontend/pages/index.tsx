...
const features = [
  ...
  },
  {
    ...
    description:
      "Builtâ€‘in calculators and charts to estimate payments and buying power in minutes.",
...
const howItWorks = [
  {
    ...
    description: "Share budget, areas, and mustâ€‘haves to set the stage.",
    icon: <User className="w-16 h-16 text-primary" />,
  },
  {
    title: "Chat & Discover",
...
const testimonials = [
  {
    testimonial:
      "homemind made finding my dream home in Chapel Hill a breeze. The interactive chat is a total game changer!",
    author: "- Alice",
  },
  {
    testimonial:
  ...
  {
    testimonial:
      "I love the interactive approach. Itâ€™s not just browsing listings - itâ€™s a conversation that guides me.",
    author: "- Charlie",
  },
  {
    testimonial:
  ...
  {
    testimonial:
      "A revolutionary approach to real estate. Itâ€™s like having a personal advisor at your fingertips.",
    author: "- Fiona",
  },
  {
    testimonial:
...
const faqs = [
  {
    question: "What is homemind?",
    answer:
      "A conversational homeâ€‘search experience with maps, insights, and calculators to move from browsing to buying with confidence.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. The UI, charts, and maps are responsive and themeâ€‘aware.",
  },
  {
...
export default function Home() {
  return (
    <>
      <Head>
        <title>homemind | Your Chapel Hill Property Assistant</title>
        <meta
          name="description"
      ...
      <div className="font-sans overflow-x-hidden bg-background text-foreground">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4">
            <AnimatedInView delay={0}>
              <span className="inline-flex items-center gap-3 rounded-full bg-white/10 px-4 py-2 text-sm font-semibold uppercase tracking-wide backdrop-blur">
                Chapel Hill Â· Carrboro Â· Durham
              </span>
            </AnimatedInView>
            ...
            <div className="pointer-events-none absolute inset-0">
              ...
              >
                ...
                <p className="text-xs text-white/70">Near UNC Â· Walkable</p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="text-xs text-white/70">Carrboro Â· Hillsborough</p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="text-sm font-semibold">
                  Saturday tour: Meadowmont â†’ Southern Village â†’ Carrboro
                </p>
                <p className="text-xs text-white/70">8 stops Â· 22 min drive</p>
              </motion.div>
              <motion.div
          ...
          <AnimatedInView delay={0}>
            <div className="max-w-6xl mx-auto text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Discover what makes homemind your smart property companion in
                Chapel Hill.
              </p>
            </div>
          </AnimatedInView>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "Responsive, themeâ€‘aware UI with privacy in mind.",
              },
            ].map((it, i) => (
        ...
        >
          ...
          <AnimatedInView delay={0}>
            <div className="max-w-6xl mx-auto text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                A few ways people put homemind to work.
              </p>
            </div>
          </AnimatedInView>
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              ...
              },
              {
                ...
                desc: "Leafletâ€‘based view to orient and compare.",
              },
              {
                icon: <BarChart3 className="w-7 h-7 text-primary" />,
                title: "Readable charts",
                desc: "Themeâ€‘aware visuals for light and dark.",
              },
              {
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "Readable charts and maps that donâ€™t get in your way.",
              },
              {
        ...
        >
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                title: "Darkâ€‘mode friendly",
                desc: "Themeâ€‘aware charts and UI for easy reading.",
              },
              {
        ...
        >
          ...
          <AnimatedInView delay={0}>
            <div className="max-w-6xl mx-auto text-center mb-12">
              <h2 className="text-4xl font-bold mb-4">Builtâ€‘In Tools</h2>
              <p className="text-lg text-muted-foreground">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                icon: <Shield className="w-8 h-8 text-primary" />,
                title: "Theme & Privacy",
                desc: "Responsive, darkâ€‘mode ready, and privacyâ€‘minded.",
              },
            ].map((it, i) => (
              <AnimatedInView key={i} delay={0.04 * i}>
                <Card className="h-full transition-shadow duration-300 hover:shadow-xl bg-card/80 backdrop-blur">
        ...
        >
          <AnimatedInView delay={0}>
            <div className="max-w-6xl mx-auto text-center mb-12">
              <h2 className="text-4xl font-bold mb-4">Who Itâ€™s For</h2>
              <p className="text-lg text-muted-foreground">
        ...
        >
          <AnimatedInView delay={0}>
            <div className="max-w-6xl mx-auto text-center mb-12">
              <h2 className="text-4xl font-bold mb-4">Why homemind</h2>
              <p className="text-lg text-muted-foreground">
          ...
          <div className="relative max-w-6xl mx-auto">
            <AnimatedInView delay={0}>
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-muted-foreground">
                  Pick a starting point and dive in - no signâ€‘up required.
                </p>
              </div>
            </AnimatedInView>
        ...
        <footer className="bg-background text-muted-foreground py-8 px-4 text-center shadow-lg">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
            <p className="text-sm">
              ...
              <strong className="font-bold">Sergio Sediq</strong>. All rights
              reserved.
            </p>
            <div className="mt-4 md:mt-0 flex flex-wrap items-center gap-4 justify-center md:justify-start">
              <Link
                href="https://github.com/SergioSediq/homemind"
