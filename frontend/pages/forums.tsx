...
const getStoredToken = () =>
  Cookies.get("homemind_token") || Cookies.get("token") || null;
...
export default function ForumsPage() {
  ...
  }, [selectedCategory, sortOption]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  }, [searchQuery, selectedCategory, sortOption]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <>
      <Head>
        <title>Community Forums | homemind</title>
        <meta
          name="description"
          content="Join the homemind community to discuss real estate, share experiences, and connect with fellow property enthusiasts"
        />
      </Head>
