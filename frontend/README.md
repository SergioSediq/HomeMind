...
Next.js + React frontend for the homemind real-estate assistant. It provides chat, insights, map, market pulse, and community forums, and integrates with the backend REST API plus a small tRPC surface for local insights data.
...
- Login stores a JWT in the `homemind_token` cookie.
