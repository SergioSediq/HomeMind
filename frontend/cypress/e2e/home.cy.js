...
describe("homemind landing page", () => {
  beforeEach(() => {
    cy.visit("/");
  });

  it("displays the hero section and scrolls to Features when â€œLearn Moreâ€ clicked", () => {
    cy.contains("h1", "homemind").should("be.visible");
  ...
  it("opens chat via â€œExplore Propertiesâ€ button", () => {
