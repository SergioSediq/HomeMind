...
Backend API for the homemind real-estate assistant. This service exposes REST and tRPC endpoints for chat, auth, property search, graph insights, commute profiles, and community forums. It also runs background scripts for Pinecone upserts and Neo4j ingest.
...
- Graph: Neo4j-powered â€œwhy/relatedâ€ property insights
