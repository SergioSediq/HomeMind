...
import { validateChatBody } from "../middleware/validateChat.middleware";
 ...
 * /api/chat:
 *   post:
 *     summary: Send a chat message to homemind
 *     tags:
 *       - Chat
 *     security:
 *       - bearerAuth: []
 ...
 *                 response:
 *                   type: string
 *                   description: The reply message from homemind.
 ...
 */
router.post("/", authMiddleware, validateChatBody, chat);
