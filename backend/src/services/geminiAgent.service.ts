...
import { chatWithHomeMind, homeMindContext } from "./geminiChat.service";
 ...
 */
export async function runhomemindAgent(
  prompt: string,
  userContext: string = "",
  ...
  const hmContext: homeMindContext = {
