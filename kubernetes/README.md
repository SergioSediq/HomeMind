...
Kustomize-based manifests for running homemind on Kubernetes. These manifests are designed to work with or without HashiCorp Consul Connect. For a multi-cloud deployment overview see `DEPLOYMENTS.md`.
...
```
kubernetes/
â”œâ”€ base/                       # Core workloads + ingress
â”œâ”€ overlays/                   # Kustomize overlays (prod, multi-region)
â”œâ”€ monitoring/                 # Prometheus, Grafana, Loki, Jaeger
â”œâ”€ jobs/                       # Batch jobs + cronjobs
â”œâ”€ chaos/                      # Chaos experiments and scripts
â”œâ”€ disaster-recovery/          # DR automation
â”œâ”€ security/                   # Security manifests (image signing)
â””â”€ scripts/                    # Blue/green + canary deploy helpers
```
...
kind: Secret
metadata:
  name: homemind-secrets
  namespace: homemind
stringData:
  mongoUri: "mongodb+srv://..."
  googleAiApiKey: "..."
  pineconeApiKey: "..."
  pineconeIndex: "homemind-index"
