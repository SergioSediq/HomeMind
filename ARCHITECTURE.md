...
This document describes the comprehensive end-to-end architecture for homemind, spanning frontend UI, backend services, API protocols (REST, tRPC, gRPC), data and graph pipelines, AI/ML systems, MCP tooling, agentic orchestration, IDE extensions, and CI/CD infrastructure.
...
homemind is a full-stack, monorepo AI/ML chatbot and data analytics platform built for real estate in Chapel Hill, NC and surrounding areas. The architecture employs a microservices-oriented design with multiple API protocols, distributed data stores, and sophisticated AI orchestration.
...
â”‚   â”‚   â”œâ”€â”€ trpc/            # tRPC implementation
â”‚   â”‚   â”‚   â”œâ”€â”€ routers/     # tRPC routers
â”‚   â”‚   â”‚   â””â”€â”€ trpc.ts      # Context & procedures
...
â”œâ”€â”€ agentic-ai/                # Multi-agent orchestration
â”‚   â”œâ”€â”€ src/
â”‚   â”‚   â”œâ”€â”€ agents/           # Agent implementations
â”‚   â”‚   â”œâ”€â”€ orchestrator/     # Default runtime
â”‚   â”‚   â”œâ”€â”€ lang/             # LangGraph runtime
â”‚   â”‚   â””â”€â”€ index.ts          # CLI entry
â”‚   â””â”€â”€ crewai/               # Python CrewAI runtime
â”œâ”€â”€ extension/                 # VS Code extension
â”œâ”€â”€ terraform/                 # Infrastructure as Code
â”œâ”€â”€ aws/                      # AWS deployment configs
â”œâ”€â”€ azure/                    # Azure deployment configs
â”œâ”€â”€ gcp/                      # GCP deployment configs
â”œâ”€â”€ kubernetes/               # K8s manifests
â””â”€â”€ hashicorp/                # Consul/Nomad configs
```

## API Protocols

homemind implements three complementary API protocols to serve different use cases:
...
homemind backend is composed of modular **microservices**, each responsible for a specific domain. Below are the key services and their internal architectures.
...
homemind runs a hybrid retrieval pipeline that blends semantic vector search with graph traversal so responses include both similar listings and explainable relationships.
...
> **Production-Ready Infrastructure**: homemind features enterprise-grade DevOps with advanced deployment strategies, comprehensive monitoring, and multi-cloud support. See [DEVOPS.md](DEVOPS.md) for complete operational documentation.
...
Helm charts live in `helm/homemind/` and mirror the Kubernetes base manifests with values tuned for CI/CD pipelines and cloud-specific annotations (EKS/AKS/GKE/OCI). Kustomize overlays remain available in `kubernetes/` for environment-specific patching.
...
- [homemind API Documentation](https://homemind-backend.vercel.app/api-docs)
- [Frontend Repository](https://github.com/SergioSediq/homemind)
