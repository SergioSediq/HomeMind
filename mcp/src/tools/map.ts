...
/** Map link helpers for deep-linking to the homemind frontend. */
export const mapTools: ToolDef[] = [
  {
    name: "map.linkForZpids",
    description:
      "Return a deep-link to the homemind map page for given ZPIDs.",
  ...
  {
    name: "map.decodeLink",
    description: "Decode an homemind map link and return its parameters.",
    schema: { url: z.string() },
    handler: async (args: any) => {
