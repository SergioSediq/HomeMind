# homemind Docker Stack

This directory contains production-grade Docker assets for the homemind monorepo.
...
## Notes
- `mongo` runs locally by default and backs the backend via `mongodb://mongo:27017/homemind`.
