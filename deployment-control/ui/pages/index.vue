  ...
  <div class="min-h-screen pb-12">
    ...
    <header class="relative z-10 max-w-7xl mx-auto px-6 pt-12 pb-6">
      <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        <div class="flex-1">
          <p class="eyebrow mb-2">homemind Delivery</p>
...
const summaryStatus = computed(() => {
  ...
  if (!store.lastUpdated.summary) return 'Awaiting dataâ€¦';
  return `Updated ${store.lastUpdated.summary.toLocaleTimeString()} Â· ${store.namespace}`;
});

const lastUpdateTime = computed(() => {
  if (!store.lastUpdated.jobs) return 'â€”';
