/**
 * homemind Pipelines - Main Entry Point
 *
 * This module provides specialized, production-ready pipelines for common
 * real estate workflows in the homemind application.
 *
...
export const Pipelines = {
  ...
  propertySearch: {
    create: () =>
      import("./propertySearch.js").then((m) => m.createPropertySearchPipeline),
    createQuick: () =>
      import("./propertySearch.js").then(
        (m) => m.createQuickPropertySearchPipeline,
      ),
    createAdvanced: () =>
      import("./propertySearch.js").then(
        (m) => m.createAdvancedPropertySearchPipeline,
      ),
    run: (goal: string, options?: any) =>
      import("./propertySearch.js").then((m) =>
        m.runPropertySearch(goal, options),
      ),
  },
  ...
  financial: {
    create: () =>
      import("./financialAnalysis.js").then(
        (m) => m.createFinancialAnalysisPipeline,
      ),
    createMortgageCalculator: () =>
      import("./financialAnalysis.js").then(
        (m) => m.createMortgageCalculatorPipeline,
      ),
    createAffordabilityChecker: () =>
      import("./financialAnalysis.js").then(
        (m) => m.createAffordabilityCheckerPipeline,
      ),
    createInvestmentAnalysis: () =>
      import("./financialAnalysis.js").then(
        (m) => m.createInvestmentAnalysisPipeline,
      ),
    run: (input: any) =>
      import("./financialAnalysis.js").then((m) =>
        m.runFinancialAnalysis(input),
      ),
    calculateMortgage: (
      price: number,
      downPayment: number,
      ...
      import("./financialAnalysis.js").then((m) =>
        m.calculateMortgage(price, downPayment, interestRate, years),
      ),
    checkAffordability: (annualIncome: number, monthlyDebts: number) =>
      import("./financialAnalysis.js").then((m) =>
        m.checkAffordability(annualIncome, monthlyDebts),
      ),
  },
  ...
  compliance: {
    create: () =>
      import("./complianceCheck.js").then(
        (m) => m.createComplianceCheckPipeline,
      ),
    createZoningCheck: () =>
      import("./complianceCheck.js").then((m) => m.createZoningCheckPipeline),
    createDisclosureVerification: () =>
      import("./complianceCheck.js").then(
        (m) => m.createDisclosureVerificationPipeline,
      ),
    createRegulatoryCompliance: () =>
      import("./complianceCheck.js").then(
        (m) => m.createRegulatoryCompliancePipeline,
      ),
    run: (input: any) =>
      import("./complianceCheck.js").then((m) => m.runComplianceCheck(input)),
    checkZoning: (address: string) =>
      import("./complianceCheck.js").then((m) => m.checkZoning(address)),
  },

  // Graph Analysis
  graph: {
    create: () =>
      import("./graphAnalysis.js").then((m) => m.createGraphAnalysisPipeline),
    createRelationshipDiscovery: () =>
      import("./graphAnalysis.js").then(
        (m) => m.createRelationshipDiscoveryPipeline,
      ),
    createPatternMatching: () =>
      import("./graphAnalysis.js").then((m) => m.createPatternMatchingPipeline),
    createNetworkClustering: () =>
      import("./graphAnalysis.js").then(
        (m) => m.createNetworkClusteringPipeline,
      ),
    run: (input: any) =>
      import("./graphAnalysis.js").then((m) => m.runGraphAnalysis(input)),
    discoverRelationships: (propertyIds: string[]) =>
      import("./graphAnalysis.js").then((m) =>
        m.discoverRelationships(propertyIds),
      ),
    findPatterns: (goal: string) =>
      import("./graphAnalysis.js").then((m) => m.findPatterns(goal)),
  },

  // Market Research
  marketResearch: {
    create: () =>
      import("./marketResearch.js").then((m) => m.createMarketResearchPipeline),
    createQuickOverview: () =>
      import("./marketResearch.js").then(
        (m) => m.createQuickMarketOverviewPipeline,
      ),
    createDeepAnalysis: () =>
      import("./marketResearch.js").then(
        (m) => m.createDeepMarketAnalysisPipeline,
      ),
    run: (goal: any) =>
      import("./marketResearch.js").then((m) =>
        m.runMarketResearchPipeline(goal),
      ),
    runLegacy: (goal: any) =>
      import("./marketResearch.js").then((m) => m.runMarketResearch(goal)),
  },
...
export const QuickPipelines = {
  ...
  comprehensiveAnalysis: async (input: any) => {
    const { runComprehensiveAnalysis } = await import(
      "./compositeWorkflows.js"
    );
...
export const PipelineTemplates = {
   ...
   */
  quickLookup: async () => {
    const { createQuickPropertySearchPipeline } = await import(
      "./propertySearch.js"
    );
  ...
  marketAnalysis: async () => {
    const { createDeepMarketAnalysisPipeline } = await import(
      "./marketResearch.js"
    );
