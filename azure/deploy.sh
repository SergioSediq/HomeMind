#!/usr/bin/env bash
# Deploy homemind backend to Azure Container Apps using the modular Bicep stack.
#
# Prerequisites:
...
RESOURCE_GROUP="homemind-rg"
LOCATION="eastus"
ENVIRONMENT_NAME="homemind"
IMAGE_TAG="latest"
IMAGE_NAME="homemind-backend"
JWT_SECRET=""
GOOGLE_AI_API_KEY=""
PINECONE_API_KEY=""
OPENAI_API_KEY=""
PINECONE_INDEX="homemind-index"
DATABASE_NAME="homeminddb"
PARAM_FILE=""
...
DEPLOYMENT_NAME="homemind-$(date +%s)"
