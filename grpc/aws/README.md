...
This directory contains an example task definition for deploying the homemind gRPC Market Pulse service to AWS ECS Fargate with AWS Cloud Map service discovery.
...
3. Create or update an ECS service referencing the new task definition:
   ...
   aws ecs create-service \
     --cluster homemind-cluster \
     --service-name market-pulse-grpc \
     --task-definition homemind-market-pulse-grpc \
     --desired-count 2 \
     --launch-type FARGATE \
