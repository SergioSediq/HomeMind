...
KUBE_CONTEXT=""
homemind_NAMESPACE="homemind"
MESH_NAMESPACE="homemind-mesh"
PLAN_ONLY=1
TF_ACTION_ARGS=()
...
Options:
  ...
  --namespace <name>        Kubernetes namespace for homemind apps (default: homemind)
  --mesh-namespace <name>   Namespace for Consul components (default: homemind-mesh)
...
BASE_VARS=(
  ...
  -var "homemind_namespace=$homemind_NAMESPACE"
